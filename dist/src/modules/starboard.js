...
class Starboard {
    ...
    setStarboardChannel(channelId) {
        this.starboardChannelId = channelId;
    }
    async handleReactionUpdate(reaction) {
        if (reaction.partial) {
        ...
        const starboardChannel = reaction.message.guild?.channels.cache.get(this.starboardChannelId);
