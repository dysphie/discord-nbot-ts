import { BaseGuildTextChannel, NewsChannel, TextChannel, Webhook } from "discord.js";
...
class WebhookManager
{
  ...
  async getWebhookForChannel(channel: BaseGuildTextChannel): Promise<Webhook|undefined> {
