...
const getWeatherCodeDescription = (codeNum: string) => {
	return codes.weatherCode[codeNum as keyof typeof codes.weatherCode];
};

export default getWeatherCodeDescription;
